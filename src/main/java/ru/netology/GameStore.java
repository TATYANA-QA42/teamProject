...
//     * Каждый объект игры помнит объект каталога, которому она принадлежит
//     */
//    public Game publishGame(String title, String genre) { // проверить
//        Game game = new Game(title, genre, this);
//        games.add(game);
//        return game;
//    }
...
//     * если игра есть и false иначе
//     */
//    public boolean containsGame(Game game) {// исправлено. но проверить
//        games.add(game); //дефект;
//        for (int i = 1; i < games.size(); i++) {
//            if (games.get(i - 1).equals(game)) {
//                return true;
//            }
...
//     * суммироваться с прошлым значением для этого игрока
//     */
//    public void addPlayTime(String playerName, int hours) {//так же как и в игроке цикл и проверки условий
//        if (playedTime.containsKey(playerName)) {
...
//     * времени. Если игроков нет, то возвращется null
//     */
//    public String getMostPlayer() { // проверка и доп условия по анализу игроков
//        int mostTime = 1;
//        String bestPlayer = null;
//        for (String playerName : playedTime.keySet()) {
//            int playerTime = playedTime.get(playerName);
...
//        return sum;
//    }
//}//полностью реализоват метод подсчета времени всех игроков
